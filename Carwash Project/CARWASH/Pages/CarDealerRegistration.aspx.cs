...
{
    public partial class CarDealerRegistration : System.Web.UI.Page
    {
        ...
        [WebMethod]
        public static DbStatusEntity[] InsertData(CarDealerEntity obj)
        {
            var details = new List<DbStatusEntity>();
            try
            {
                details.Add(new CarDealerDAO().InsertCarDealers(obj));
                ...
                strsub = "New Car dealer registartion : " + obj.FIRM_NAME;
                strmsg = "Hi," + "<br>We have a new car dealer registartion with below details:<br>";
                strmsg = strmsg + "<b>Company</b> : " + obj.FIRM_NAME + ".<br>";
                strmsg = strmsg + "<b>Contact</b> : " + obj.FIRST_NAME + " " + obj.LAST_NAME + ".<br>";
                strmsg = strmsg + "<b>Email</b>   : " + obj.EMAIL + ".<br>";
                strmsg = strmsg + "<b>Question</b>: " + obj.QUESTIONS + ".<br><br>";
                strmsg = strmsg + "For more details please follow the link : <a href='"+ System.Configuration.ConfigurationManager.AppSettings["PORTALURL"] + "Pages/CarDealerView.aspx?id=" + details[0].CNT +"'>Car Wash Management Services Inc Portal</a><br><br>";
